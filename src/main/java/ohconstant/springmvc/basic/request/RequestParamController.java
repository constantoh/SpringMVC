...
/**
 * RestController가 아닌 그냥 Controller에서 view 조회가 아닌 body에 응답메세지를 담는 법. -> ResponseBody
 */
@Slf4j
@RestController
public class RequestParamController {
    ...
    /**
     * @ModelAttribute 사용
     * 참고 : model.addAttribute(helloData) 자동 적용됨.
     */
    @ResponseBody
     ...
     * 파라미터가 String, int 같은 단순 타입 => @RequestParam
     * 파라미터가 argument resolver 로 지정해둔 타입 외( 새로 생성한 클래스 ) = @ModelAttribute
     */
    @ResponseBody
